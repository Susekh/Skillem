import { Users, Target, Lightbulb, TrendingUp, Handshake } from "lucide-react" 
    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Empowering Futures: About SKILLEM</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            At SKILLEM, we empower young professionals with practical knowledge and confidence,
            transforming them into industry-ready individuals for both corporate and community impact.
          </p>
        </div>

        {/* Adjusted grid to handle 5 cards, using a responsive layout */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center mb-6"> {/* New color */}
              <TrendingUp className="h-8 w-8 text-purple-600" /> {/* New icon */}
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-yellow-100 rounded-2xl flex items-center justify-center mb-6"> {/* New color */}
              <Handshake className="h-8 w-8 text-yellow-600" /> {/* New icon */}
            </div>
